...
They can be found https://docs.spring.io/spring-boot/{spring-boot-version}/appendix/application-properties/index.html[in
...
The can be found in
https://docs.spring.io/spring-boot/{spring-boot-version}/appendix/dependency-versions/coordinates.html[the
